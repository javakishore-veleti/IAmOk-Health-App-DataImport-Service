...
public class TeacherIngestServiceImpl implements TeacherIngestService {
	...
	private final Job teacherIngestJob;

	public TeacherIngestServiceImpl(JobLauncher jobLauncher, Job teacherIngestJob) {
		this.jobLauncher = jobLauncher;
		this.teacherIngestJob = teacherIngestJob;
	}
	...
	public void ingestTeachers(TeachersIngestReq request, String ingestLogId) {
		...
		try {
			...
			jobLauncher.run(teacherIngestJob, jobParameters);
		} catch (Exception e) {
